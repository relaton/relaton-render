  ...
  it "disambiguates author-cite citations" do
    ...
    output = {
      ...
      "D" => {
        ...
        citation: {
          default: "",
          short: "<esc>ALUFFI</esc>, Paolo and David <esc>ANDERSON</esc> (eds.). <em>Facets of Algebraic Geometry: A Collection in Honor of William Fulton's 80th Birthday</em>. 1st edition. (London Mathematical Society Lecture Note Series 472.) Cambridge, UK: Cambridge University Press. 2022. DOI: https://doi.org/10.1017/9781108877831. ISBN: 9781108877831. 1 vol.",
  ...
  it "does not add date accessed by default to set of citations" do
    ...
    output = {
      "A" => {
        ...
        citation: {
          default: "",
          short: "<esc>ALUFFI</esc>, Paolo (ed.). <em>Book 1</em>. Cambridge, UK: Cambridge University Press. 2021.",
      ...
      "B" => {
        ...
        citation: {
          default: "",
          short: "<esc>ALUFFI</esc>, Paolo (ed.). <em>Book 2</em>. Cambridge, UK: Cambridge University Press. 2022.",
      ...
      "C" => {
        ...
        citation: {
          default: "",
          short: "<esc>ALUFFI</esc>, Paolo (ed.). <em>Standard 1</em>. Cambridge, UK: Cambridge University Press. 2023.",
      ...
      "D" => {
        ...
        citation: {
          default: "",
          short: "<esc>ALUFFI</esc>, Paolo (ed.). <em>Standard 2</em>. Cambridge, UK: Cambridge University Press. 2024.",
  ...
  it "generates generic citations" do
    ...
    output = {
      "A" => {
        ...
        citation: {
          default: "ABC1",
          short: "<esc>ALUFFI</esc>, Paolo (ed.). <em>Facets of Algebraic Geometry: A Collection in Honor of William Fulton's 80th Birthday</em>. 1st edition. (London Mathematical Society Lecture Note Series 472.) Cambridge, UK: Cambridge University Press. 2022a. ABC1. 1 vol.",
      ...
      "B" => {
        ...
        citation: {
          default: "ABC2",
          short: "<esc>ALUFFI</esc>, Paolo (ed.). <em>Facets of Algebraic Geometry: A Collection in Honor of William Fulton's 80th Birthday</em>. 1st edition. (London Mathematical Society Lecture Note Series 472.) Cambridge, UK: Cambridge University Press. 2022b. ABC2. 1 vol.",
