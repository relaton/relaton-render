        ...
        <number>472</number>
            ...
            <contributor>
              ...
              <organization>
                ...
                <abbreviation>OUP</abbreviation>
              </organization>
            </contributor>
            <place><formattedPlace>Oxford, UK</formattedPlace></place>
          <size><value type="page">lxii</value><value type="page">500</value></size>
      </bibitem>
    INPUT
    template = <<~TEMPLATE
      {{ creatornames }} ,_{{role}} ({{date}}) . <em><title>{{ title }}</title></em> [{{medium}}] ,_{{ edition }} .
      {{ place }} : {{ publisher }} . {{ uri }}. At:_{{ access_location }}.
    TEMPLATE
    output = <<~OUTPUT
      <formattedref>Aluffi, P, ed. (2022).  <em><title>Facets of Algebraic Geometry: A Collection in Honor of William Fulton's 80th Birthday</title></em>, 1st edition. Oxford, UK: Cambridge University Press and Oxford University Press.</formattedref>
    OUTPUT
    p = Relaton::Render::General
      .new(template: { book: template }, language: "en",
           nametemplate: {
